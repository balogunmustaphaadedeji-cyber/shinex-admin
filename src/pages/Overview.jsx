...
import { api } from "../api";
import { Skeleton, ErrorState, money } from "../components/ui";

/* There is no GET /admin/stats endpoint on the backend — the overview
   is composed from totals already returned by the existing list
   endpoints, exactly like the marketplace's admin dashboard does. */
export default function Overview() {
  ...
  const cards = [
    { label: "Total Users", value: stats.users, icon: Users, bg: "#5B3FC6" },
    ...
    { label: "Revenue", value: money(stats.revenue), icon: CreditCard, bg: "#159A61" },
